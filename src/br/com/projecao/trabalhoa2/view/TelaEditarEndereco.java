...
public class TelaEditarEndereco extends JDialog {
	...
	public TelaEditarEndereco(Endereco Retorno) {
		Dados = getEndereco().pesquisarEditarEndereco(Retorno);
		this.setTitle("Cadastrar Endereco" + Dados.getEndereco());
		this.setLayout(null);
		Cor b = new Cor();
